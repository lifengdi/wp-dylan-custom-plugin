...
function imagex_file_upload($object, $filename, $no_local_file = false)
{
    ...
    try {
        ...
        error_log('ImageX 文件上传出错: '. $e->getMessage());
        return false;
    }
...
function imagex_delete_local_file($file)
{
    try {
        ...
        error_log('删除本地文件出错: '. $e->getMessage());
        return false;
    }
}
...
function imagex_delete_files(array $files)
{
    ...
    try {
        ...
        error_log('ImageX 删除文件出错: '. $e->getMessage());
    }
}
...
function imagex_setting_page()
{
    ...
    <div class="wrap" style="margin: 10px;">
        ...
        <p>如果觉得此插件对你有所帮助，不妨到 <a href="https://github.com/lifengdi/wp-dylan-custom-plugin" target="_blank">GitHub</a> 上点个<code>Star</code>，<code>Watch</code>关注更新；</p>
        <hr/>
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p>如：<code>https://resources.lifengdi.com</code></p>
                    </td>
                </tr>
                <tr>
                    <th>
